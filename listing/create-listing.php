		...
		<form method="POST" action="includes/create-listing-request.inc.php" enctype="multipart/form-data">
			<div class="row">
				...
				<div class="col-6 text-center bg-secondary p-3 rounded">
					<input type="text" name="title" placeholder="Title" maxlength="50" id="title" class="p-2 mb-4 border-0 rounded w-100">
					<br>
					...
					<br>
					<textarea name="description" rows="7" cols="55" maxlength="500" placeholder="Description" id="description" class="p-2 mb-4 border-0 rounded w-100"></textarea>
					<br>
					<input type="text" name="keywords" placeholder="Keywords (,)" id="keywords" class="p-2 mb-4 border-0 rounded w-100">
					<br>
					<button class="btn btn-outline-light btn-lg m-4">
						<input type="file" name="images[]" multiple="multiple" id="product-images" onchange="readURL(this);">
					</button>
					<br>
